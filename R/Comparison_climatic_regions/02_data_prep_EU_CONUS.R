...
# - Load trait data EU (.rds, already in data.table format)
...
# - Meaning KG classification (merged with KG classification)
...
# Overall, from the taxa we extracted 2422 have an ecoregion assignment
