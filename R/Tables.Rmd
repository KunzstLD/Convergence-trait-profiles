...
Five most important traits to distinguish TPGs for each continent. After the initial run the highest
ranking variable has been removed and a random forest has been fitted again.
This procedure has been repeated 4 times. Training error and test error for the fitted random 
forest are shown in the last two columns.
